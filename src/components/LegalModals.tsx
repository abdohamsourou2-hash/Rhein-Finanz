          ...
          {activeModal === 'impressum' && (
            <div className="space-y-6">
              ...
              <div>
                ...
                <p><strong>E-Mail:</strong> <a href="mailto:info@rheinfinanz.com" className="text-[#c4a323] hover:underline font-medium">info@rheinfinanz.com</a></p>
                <p><strong>Website:</strong> <a href="https://www.rheinfinanz.com" className="text-[#c4a323] hover:underline">www.rheinfinanz.com</a></p>
              </div>
              ...
              <div>
                ...
                <p className="text-xs text-gray-600">
                  ...
                  Unsere E-Mail-Adresse lautet: <a href="mailto:info@rheinfinanz.com" className="text-[#c4a323] hover:underline">info@rheinfinanz.com</a>.<br />
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <div className="bg-gray-50 p-4 rounded-xl border border-gray-200 text-xs space-y-1">
                  ...
                  <p>E-Mail: info@rheinfinanz.com</p>
                </div>
              </div>
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <div className="bg-gray-50 p-4 rounded-xl border border-gray-200 text-xs space-y-2">
                  ...
                  <p><strong>E-Mail:</strong> info@rheinfinanz.com | <strong>Web:</strong> www.rheinfinanz.com</p>
              ...
              <div className="border-t border-gray-200 pt-5">
                ...
                <div className="bg-gray-50 p-4 rounded-xl border border-gray-200 text-xs space-y-3">
                  ...
                  <div>
                    ...
                    Um Ihr Widerrufsrecht auszuüben, müssen Sie uns (Rhein-Finanz, Inh. Hamo Hussein, Hauptstraße 68, 53340 Meckenheim, Tel: 02225 8305776, E-Mail: info@rheinfinanz.com) mittels einer eindeutigen Erklärung (z.B. ein mit der Post versandter Brief oder eine E-Mail) über Ihren Entschluss, diesen Vertrag zu widerrufen, informieren.
                  </div>

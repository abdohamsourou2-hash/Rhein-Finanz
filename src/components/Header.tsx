...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-40 bg-white/95 backdrop-blur-md border-b border-[#1E2229]/10 shadow-xs">
      ...
      <div className="bg-[#1E2229] text-white text-xs py-2 px-4 sm:px-6 lg:px-8 border-b border-white/5">
      ...
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20 gap-3 xl:gap-6 w-full">
          
          {/* Left Column: Brand Logo & Title (shrink-0 ensures no shrink or collision) */}
          <div className="flex items-center shrink-0">
            <a href="#" className="flex items-center gap-2.5 sm:gap-3 group focus:outline-hidden" aria-label="Rhein-Finanz Startseite">
              ...
              <div className="flex flex-col">
                <span className="text-xl sm:text-2xl font-black tracking-tight text-[#1E2229] leading-none">
                  Rhein<span className="text-[#c4a323]">-</span>Finanz
                </span>
                <span className="text-[10px] sm:text-[11px] font-bold uppercase tracking-wider text-[#c4a323] mt-0.5 whitespace-nowrap">
          ...
          {/* Center Column: Clean, Perfectly Spaced Desktop Navigation Links */}
          <nav className="hidden lg:flex items-center justify-center gap-0.5 xl:gap-1.5">
            ...
            >
              <span>Karriere</span>
              <span className="text-[9px] xl:text-[10px] font-black bg-[#c4a323]/20 text-[#1E2229] px-1.5 py-0.5 rounded-full uppercase tracking-wider">
                Partner
              </span>
            </a>
          </nav>

          {/* Right Column: Direct CTA Action Buttons (shrink-0 ensures no overlap) */}
          <div className="hidden lg:flex items-center justify-end gap-2 xl:gap-2.5 shrink-0">
            {/* Call Button */}
            <a
              href="tel:022258305776"
              id="header-call-cta"
              className="shimmer-btn inline-flex items-center gap-1.5 xl:gap-2 px-3 py-2 xl:px-3.5 xl:py-2.5 rounded-xl font-bold text-xs xl:text-sm text-[#1E2229] bg-[#c4a323] hover:bg-[#b3921b] transition-all shadow-xs hover:shadow-md active:scale-98 whitespace-nowrap shrink-0"
